SystemUtil.Run"C:\ProgramData\Microsoft\Windows\Start Menu\Programs\Micro Focus\Micro Focus Unified Functional Testing\Sample Applications\Flight GUI.lnk"
 ...
 @@ hightlight id_;_1246244_;_script infofile_;_ZIP::ssf12.xml_;_
WpfWindow("Micro Focus MyFlight Sample").WpfEdit("agentName").Set "john" @@ hightlight id_;_1940290472_;_script infofile_;_ZIP::ssf13.xml_;_
WpfWindow("Micro Focus MyFlight Sample").WpfEdit("password").SetSecure "5d9ae474794c5a17d21d" @@ hightlight id_;_1928779384_;_script infofile_;_ZIP::ssf2.xml_;_
WpfWindow("Micro Focus MyFlight Sample").WpfButton("OK").Click @@ hightlight id_;_1928783560_;_script infofile_;_ZIP::ssf3.xml_;_
